...
function drawHeader(doc, y, { nro, fechaEmision, oc, modalidad }) {
  ...
  doc.text(`OC ${oc || '-'}`, rx + rightW, y + 19, { align: 'right' })
  doc.setFontSize(7.2)
...
export function construirHtmlRemision(doc, { nro, fechaEmision, fechaEntrega, sitio, oc, modalidad, productos, totalUnd, totalVal }) {
  let y = MARGIN
  y = drawHeader(doc, y, { nro, fechaEmision, oc, modalidad })
