...
const COLS = [
  { key: 'num', label: '#', w: 8 },
  { key: 'colegio', label: 'COLEGIO', w: 45 },
  { key: 'hLlegada', label: 'H. LLEGADA', w: 16 },
  { key: 'hRecibido', label: 'H. RECIBIDO', w: 16 },
  { key: 'hSalida', label: 'H. SALIDA', w: 16 },
  { key: 'temperatura', label: 'TEMPERATURA', w: 22 },
  { key: 'quienRecibe', label: 'QUIEN RECIBE', w: 28 },
  { key: 'cargo', label: 'CARGO', w: 22 },
  { key: 'planillas', label: 'PLANILLAS', w: 16 },
  { key: 'interventoria', label: 'INTERVENTORÍA', w: 18 },
  { key: 'canastillas', label: 'CANASTILLAS', w: 20 },
  { key: 'observaciones', label: 'OBSERVACIONES', w: 36.4 },
]
