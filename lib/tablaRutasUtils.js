...
export function buildRutasAsciiText(tituloTabla, conductores, totalTipo1, totalTipo2) {
  const headers = ['Conductor', 'Auxiliar', 'Placa', 'Cargue Alinnova', 'Id Sitio Entrega', 'Nombre y/o Descripción Sitio de Entrega', 'Horario Sugerido Compensar', 'Horario Entrega Alinnova', 'Orden Entrega', 'Total Tipo 1', 'Total Tipo 2', 'Dirección de Entrega']
  const rows = []
